                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Insertar nuevo canal</h6>
                        </div>
                        <div class="card-body">
                            <!-- EN ESTE PINCHE CUADRO VAN LAS API -->
                            <div class="table-responsive">
                                <form action="bdd/post.php" method="POST">
                                    <table class="table table-hover table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td> <input class="form-control" type="text" name="canal" id=""> </td>
                                                <td> <input class="form-control" type="text" name="id_yt" id=""> </td>
                                            </tr>
                                    </table>
